...
public class Main_ejercicio03 {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		do {
			...
			System.out.println(
					SUMAR + ". Introducir un numero por teclado y que saque la suma del mismo con sus inferiores");
			System.out.println(MULTIPLO_5
					+ ". introducir un numero por teclado y sacar por pantalla los multiplos de 5 inferiores");
			...
			case CONTAR_PALABRA:
				...
				System.out.println(
						"La palabra " + "\'" + palabra + "\' aparece " + contar_palabra(palabra, fichero) + " vece(s)");
				break;
